    ...
    useEffect(() => {
        ...
        const unsubscribe = onSnapshot(
            ...
            (snapshot) => {
                ...
                // Filter for visits
                const visitRecords = allRecords.filter(
                    (r: any) =>
                        r.type === 'consultation' ||
                        r.type === 'visit' ||
                        r.tags?.includes('visit') ||
                        r.title?.toLowerCase().includes('visit')
                );

                setRecords(visitRecords);
                setLoading(false);
            },
            (error) => {
        ...
        <SafeAreaView style={styles.container}>
            <View style={[styles.header, { flexDirection: 'row', alignItems: 'center' }]}>
                ...
                <View style={{ marginLeft: 16 }}>
                    <Text style={styles.headerTitle}>Visits History</Text>
                ...
                {records.length > 0 ? (
                    ...
                    <View style={styles.emptyState}>
                        ...
                        <Text style={styles.emptyStateText}>
                            You haven't added any visit records yet.
                        </Text>
                    </View>
                )}
            </ScrollView>
